...
public class TransactionServiceImpl implements com.example.demo.finance.service.interfaces.TransactionService {
    ...
    private boolean isMonthlyDueMember(Member member) {
        return member.getDeletedAt() == null
                && member.getGraduatedStatus() != com.example.demo.shared.enums.GraduatedStatusEnum.GRADUATED
                && member.getGraduatedStatus() != com.example.demo.shared.enums.GraduatedStatusEnum.INACTIVE;
    }
