...
export default function ResourceMoveModal({ resource, onCancel, onConfirm, loading = false }) {
  ...
  return (
    <div className={styles.overlay} onClick={onCancel}>
      <div className={styles.box} onClick={(event) => event.stopPropagation()}>
        ...
        <h3 className={styles.title}>Di chuyển tài liệu sang folder khác</h3>
        <p className={styles.message}>
          Chọn thư mục đích cho tài liệu <strong>{resource.title}</strong>.
        </p>
